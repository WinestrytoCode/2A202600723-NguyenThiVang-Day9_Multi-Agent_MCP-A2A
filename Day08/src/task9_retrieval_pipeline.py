...
def retrieve(
    ...
    # If using cross-encoder, it returns arbitrary logit scores, sometimes negative.
    # We'll normalize or adjust the threshold logic if needed, but for now we follow the simple logic.
